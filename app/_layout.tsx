...
import { RecipePreviewProvider } from '../lib/recipePreview/RecipePreviewContext';
      ...
      <AuthProvider>
        ...
        <InventoryProvider>
          ...
          <ShoppingListProvider>
            {/* Shared by Home and Cook › Suggested. */}
            <DailySuggestionsProvider>
            {/* Hands an unsaved recipe (daily suggestion or Sous Chef
                reply) to the recipe-preview screen. */}
            <RecipePreviewProvider>
            <StatusBar style="dark" />
            <Stack screenOptions={{ headerShown: false }}>
              <Stack.Screen name="(auth)" />
              <Stack.Screen name="(tabs)" />
              <Stack.Screen name="sous-chef" options={{ presentation: 'modal', headerShown: true, title: 'Sous Chef' }} />
              <Stack.Screen name="recipe-preview" options={{ headerShown: true, title: 'Recipe Preview' }} />
